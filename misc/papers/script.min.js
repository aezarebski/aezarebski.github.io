...
/*
  ...
  ============================================================
*/
// Default opacity of the nodes
const defaultOpacity = 0.3;
// Minimum radius for nodes in the visualization
const baseRadius = 5;
...
d3.json(dataFile).then(data => {
	...
	if (outDegreeMap.hasOwnProperty(link.source)) {
            outDegreeMap[link.source] += 1;
	}
	if (outDegreeMap.hasOwnProperty(link.target)) {
            outDegreeMap[link.target] += 1;
	}
    });
    console.log(outDegreeMap);
    data.nodes.forEach(node => {
	node.radius = baseRadius + (outDegreeMap[node.id] + 1);
    });
